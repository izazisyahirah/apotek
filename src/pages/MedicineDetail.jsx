...
export default function MedicineDetail() {
  ...
  const handleLikeToggle = () => {
    const fullId = `medicine-${product.id}`;
  ...
  const isLiked = likedProducts.includes(`medicine-${product.id}`);
  ...
  return (
    <>
      ...
      <div className="px-4 py-10 max-w-6xl mx-auto">
        ...
        >
          <FaArrowLeft className="mr-2" /> Kembali ke Daftar Obat
        </button>
            ...
            <div>
              ...
              <ul className="text-sm text-gray-700 space-y-2 mb-6">
                ...
                <li>
                  ...
                  {formatTanggal(tanggal_kadaluarsa)}
                </li>
              </ul>
              ...
              <p className="text-xl font-bold text-green-700">
                Harga: Rp {parseInt(harga_obat).toLocaleString("id-ID")}
              </p>
            </div>
              ...
              {rekomendasi.map((item) => (
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm mb-2">
                    Rp{parseInt(item.harga_obat).toLocaleString("id-ID")}
                  </p>
                </div>
              ))}
            </div>
